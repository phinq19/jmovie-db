...
public class JLabeledComboBox<V> extends JLabeled {
	...
	private JComboBox<V> cbBox = null;

	public JLabeledComboBox(final String labelText, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx, final Integer paddingy) {
	...
	public JLabeledComboBox(final String labelText, final Vector<V> v, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx,
	...
	public JLabeledComboBox(final String labelText, final ComboBoxModel<V> cbmModel, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight,
