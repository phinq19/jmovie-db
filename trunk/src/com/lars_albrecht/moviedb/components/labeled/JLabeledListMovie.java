...
public class JLabeledListMovie<V> extends JLabeledList<V> implements IMovieTabComponent {
	...
	public JLabeledListMovie(final String labelText, final Vector<? extends V> lV, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx,
			final Integer paddingy) {
		super(labelText, lV, labelPosition, labelWidthHeight, widthHeight, paddingx, paddingy);
	}

	public JLabeledListMovie(final String labelText, final ListModel<V> lLm, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx,
			final Integer paddingy) {
		super(labelText, lLm, labelPosition, labelWidthHeight, widthHeight, paddingx, paddingy);
	}

	public JLabeledListMovie(final String labelText, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx, final Integer paddingy) {
	...
	public void select(final Object o) {
		...
		if (o == null) {
			...
			final ListModel<KeyValue<Integer, String>> listModel = (ListModel<KeyValue<Integer, String>>) this.getlList().getModel();
