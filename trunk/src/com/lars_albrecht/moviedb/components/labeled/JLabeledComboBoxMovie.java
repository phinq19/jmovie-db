...
public class JLabeledComboBoxMovie<V> extends JLabeledComboBox<V> implements IMovieTabComponent {
	...
	public JLabeledComboBoxMovie(final String labelText, final Vector<V> v, final Integer labelPosition,
	...
	public JLabeledComboBoxMovie(final String labelText, final Integer labelPosition, final Dimension labelWidthHeight,
	...
	public JLabeledComboBoxMovie(final String labelText, final ComboBoxModel<V> cbmModel, final Integer labelPosition,
			final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx, final Integer paddingy) {
