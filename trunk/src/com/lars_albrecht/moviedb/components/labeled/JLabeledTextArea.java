...
public class JLabeledTextArea extends JLabeled {
	...
	public JLabeledTextArea(final String labelText, final String inputText, final Integer labelPosition, final Dimension labelWidthHeight, final Dimension widthHeight, final Integer paddingx,
