...
public class TypeInformation implements IPersistable {
	 ...
	 * @param valueId
	 */
	public TypeInformation(final Integer fileId, final Integer keyId,
			final Integer valueId) {
		super();
		this.fileId = fileId;
		this.keyId = keyId;
	 ...
	 * @param valueId
	 */
	public TypeInformation(final Integer id, final Integer fileId,
			final Integer keyId, final Integer valueId) {
		super();
		this.id = id;
		this.fileId = fileId;
		this.keyId = keyId;
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((this.keyId == null) ? 0 : this.keyId.hashCode());
		result = prime * result
				+ ((this.valueId == null) ? 0 : this.valueId.hashCode());
		return result;
	}
	...
	public String toString() {
		return "Id: " + this.id + " | " + "FileId: " + this.fileId + " | "
				+ "KeyId: " + this.keyId + " | " + "ValueId: " + this.valueId;
	}
